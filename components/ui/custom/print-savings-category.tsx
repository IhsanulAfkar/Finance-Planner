...
import { TSavingsCategory } from '@/hooks/datasource/useSavingsCategory'
...
const PrintSavingsCategory: NextPage<Props> = ({ category, onUpdate }) => {
  ...
  const updateCategory = async () => {
    ...
    try {
      const res = await httpClient.put(`/savings/categories/${editCategory.id}`, {
...
export default PrintSavingsCategory